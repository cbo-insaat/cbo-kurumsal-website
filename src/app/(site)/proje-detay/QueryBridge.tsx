    ...
    return (
      <main className="min-h-[60vh] grid place-items-center px-6 mt-20">
        <div className="max-w-xl text-center">
          <h1 className="text-2xl font-bold text-gray-900">Proje bulunamadı</h1>
          <p className="mt-2 text-gray-600">
            Geçersiz ya da eksik bir bağlantı kullandınız. Lütfen projeler sayfasından tekrar deneyin.
          </p>
        </div>
      </main>
    );
